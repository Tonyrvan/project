...
# 1. LOAD DATA
print("📂 Loading data for Bi-LSTM...")
...
# Split data (Gunakan random_state yang sama dengan Stacked agar test set-nya identik)
X_train, X_test, y_train, y_test = train_test_split(X_reshaped, y_res, test_size=0.2, random_state=42, stratify=y_res)

# 3. MODELING (Bidirectional LSTM 3 Layer)
...
# 5. SIMPAN SEMUA RESOURCE (Nama file disesuaikan dengan Streamlit)
print("💾 Menyimpan file Bi-LSTM untuk Streamlit...")
...
# Simpan Data Test (Opsional, jika sudah simpan di stacked tidak perlu, tapi buat jaga-jaga)
